    ...
    <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
      <div className="mt-4">
        ...
        <div className="flex justify-center mt-4">
          <Image className="rounded-full" src="/avatar/0-100.jpg" width={60} height={60} alt="Avatar" />
        </div>
      </div>
      <div className="mt-4">
      ...
      <div className="flex justify-around mt-6">
        ...
        <div>
          <a href="https://www.facebook.com/groups/explore/" target="_blank" rel="noopener noreferrer">
            <svg
        ...
        <div>
          <a href="https://github.com/POLARBEARS-18/next_HP_project" target="_blank" rel="noopener noreferrer">
            <svg
